...
export const VERIFIED_EXERCISE_MEDIA: Record<string, ExerciseMedia> = {
  ...
  leg_raise: {
    animationKey: "leg_raise",
    type: "video",
    url: "https://commons.wikimedia.org/wiki/Special:Redirect/file/Leg_raises_-_exercise_demonstration_video.webm",
    source: "Wikimedia Commons",
    license: "CC BY 3.0",
    attribution: "FitnessScape",
