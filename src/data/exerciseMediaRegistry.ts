...
export type ExerciseMedia = VideoExerciseMedia | FramePairMedia;
...
if (VERIFIED_MEDIA_COUNT !== 122) throw new Error(`FysiqForge media audit error: expected 122 verified mappings, found ${VERIFIED_MEDIA_COUNT}`);
