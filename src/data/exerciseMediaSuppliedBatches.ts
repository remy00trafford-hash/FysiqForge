...
["push_press","Barbell_Push_Press"],["seated_barbell_overhead_press","Barbell_Seated_Overhead_Press"],["standing_dumbbell_shoulder_press","Dumbbell_Shoulder_Press"],["seated_dumbbell_shoulder_press","Dumbbell_Seated_Shoulder_Press"],["arnold_press","Dumbbell_Arnold_Press"],["dumbbell_lateral_raise","Dumbbell_Lateral_Raise"],["seated_dumbbell_lateral_raise","Dumbbell_Seated_Lateral_Raise"],["cable_lateral_raise","Cable_Lateral_Raise"],["dumbbell_front_raise","Dumbbell_Front_Raise"],["barbell_front_raise","Barbell_Front_Raise"],["cable_front_raise","Cable_Front_Raise"],["rear_delt_dumbbell_fly","Dumbbell_Rear_Delt_Fly"],["cable_rear_delt_fly","Cable_Reverse_Fly"],["face_pull","Cable_Face_Pull"],["barbell_upright_row","Barbell_Upright_Row"],["dumbbell_upright_row","Dumbbell_Upright_Row"],["barbell_shrug","Barbell_Shrug"],["dumbbell_shrug","Dumbbell_Shrug"],["machine_shoulder_press","Lever_Shoulder_Press"],["smith_machine_shoulder_press","Smith_Machine_Shoulder_Press"],
...
if (SUPPLIED_EXACT_FRAME_PAIR_COUNT !== 104) throw new Error(`Expected 104 master-compatible additions, found ${SUPPLIED_EXACT_FRAME_PAIR_COUNT}`);
